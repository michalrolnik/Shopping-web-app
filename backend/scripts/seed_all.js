...
const MONGO_URI =
  ...
  "mongodb+srv://rolnikmichal:050796mr@cluster0.8b5d4kw.mongodb.net/Ecommerce?retryWrites=true&w=majority";
...
(async () => {
  try {
    ...
    // בונים את המערך לפי all_products.js שלך
    const products = [
      // 1-12 women
